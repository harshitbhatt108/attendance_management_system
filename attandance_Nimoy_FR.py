...
def manually_fill():
    global sb
    sb = tk.Tk()
    sb.iconbitmap(r'C:/FR_Nimoy/AMS.ico')
    ...
    def err_screen_for_subject():
        ...
        ec = tk.Tk()
        ec.geometry('300x100')
        ec.iconbitmap(r'C:/FR_Nimoy/AMS.ico')
        ec.title('Warning!!')
    ...
    def fill_attendance():
        ...
        sql = "CREATE TABLE " + DB_table_name + """
                        (ID INT NOT NULL AUTO_INCREMENT,
                         ENMPLOYEE_NUM varchar(100) NOT NULL,
        ...
        if subb=='':
            ...
            sb.destroy()
            MFW = tk.Tk()
            MFW.iconbitmap(r'C:/FR_Nimoy/AMS.ico')
            ...
            def err_screen1():
                ...
                errsc2.iconbitmap(r'C:/FR_Nimoy/AMS.ico')
            ...
            def enter_data_DB():
                ...
                if Employee_num=='':
                    ...
                    VALUES = (str(Employee_num), str(STUDENT), str(Date), str(time))
                    try:
            ...
            def create_csv():
                ...
                csv_name='C:\FR_Nimoy\Attendance\Manually AttendanceC:\FR_Nimoy\Attendance\Manually Attendance'+DB_table_name+'.csv'
...
def err_screen1():
    ...
    sc2.iconbitmap(r'C:/FR_Nimoy/AMS.ico')
    sc2.title('Warning!!')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            Time = datetime.datetime.fromtimestamp(ts).strftime('%H:%M:%S')
            row = [Employee_num, Name, Date, Time]
            with open(r'C:\FR_Nimoy\EmployeeDetails\EmployeeDetails.csv', 'a+') as csvFile:
                writer = csv.writer(csvFile, delimiter=',')
                writer.writerow(row)
                csvFile.close()
            res = "Images Saved for Employee : " + Employee_num + " Name : " + Name
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                col_names = ['Employee_num', 'Name', 'Date', 'Time']
                ...
                while True:
                    ...
                    for (x, y, w, h) in faces:
                        ...
                        if (conf > 50):
                            ...
                            date = datetime.datetime.fromtimestamp(ts).strftime('%Y-%m-%d')
                            timeStamp = datetime.datetime.fromtimestamp(ts).strftime('%H:%M:%S')
                            aa = df.loc[df['Employee_num'] == Id]['Name'].values
                            global tt
                            tt = str(Id) + "-" + aa
                            En = '15624031' + str(Id)
                    ...
                    attendance = attendance.drop_duplicates(['Employee_num'], keep='first')
...
def admin_panel():
    win = tk.Tk()
    win.iconbitmap(r'C:/FR_Nimoy/AMS.ico')
    win.title("LogIn")
...
def trainimg():
    ...
    try:
        recognizer.save(r"C:/FR_Nimoy/Trainer/trainer.yml")
    except Exception as e:
        q='Please make "Trainer" folder'
...
window.iconbitmap(r'C:/FR_Nimoy/AMS.ico')
...
lbl = tk.Label(window, text="Enter Employee number", width=20, height=2, fg="black", bg="powder blue", font=('times', 15, ' bold '))
...
clearButton = tk.Button(window, text="Clear",command=clear,fg="black"  ,bg="powder blue"  ,width=10  ,height=1 ,activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="black"  ,bg="powder blue"  ,width=10 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
