...
def manually_fill():
    global sb
    sb = tk.Tk()
    sb.iconbitmap(r'C:\Users\SUNITA BHATT\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
    ...
    def err_screen_for_subject():
        ...
        ec = tk.Tk()
        ec.geometry('300x100')
        ec.iconbitmap(r'C:\Users\SUNITA BHATT\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
        ec.title('Warning!!')
        ec.configure(background='snow')
        Label(ec, text='Please enter your Department!!!', fg='red', bg='white', font=('times', 16, ' bold ')).pack()
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            sb.destroy()
            MFW = tk.Tk()
            MFW.iconbitmap(r'C:\Users\SUNITA BHATT\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
            ...
            def err_screen1():
                ...
                errsc2.iconbitmap(r'C:\Users\SUNITA BHATT\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
                errsc2.title('Warning!!')
                errsc2.configure(background='snow')
                Label(errsc2, text='Please enter Employee Name & Employee number!!!', fg='red', bg='white',
            ...
            ENR = tk.Label(MFW, text="Enter Employee number", width=15, height=2, fg="white", bg="blue2",
                           font=('times', 15, ' bold '))
            ENR.place(x=30, y=100)

            STU_NAME = tk.Label(MFW, text="Enter Employee name", width=15, height=2, fg="white", bg="blue2",
                                font=('times', 15, ' bold '))
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\FR_Nimoy\Attendance\Manually Attendance\-------Check atttendance-------"')

            attf = tk.Button(MFW,  text="Check Data",command=attf,fg="black"  ,bg="lawn green"  ,width=12  ,height=1 ,activebackground = "Red" ,font=('times', 14, ' bold '))
...
def err_screen():
    ...
    sc1.iconbitmap(r'C:\Users\SUNITA BHATT\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
    sc1.title('Warning!!')
...
def err_screen1():
    ...
    sc2.iconbitmap(r'C:\Users\SUNITA BHATT\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
    sc2.title('Warning!!')
    sc2.configure(background='snow')
    Label(sc2,text='Please enter your dept name!!!',fg='red',bg='white',font=('times', 16, ' bold ')).pack()
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            detector = cv2.CascadeClassifier(r'C:\FR_Nimoy\haarcascade_frontalface_default.xml')
            Enrollment = txt.get()
            Name = txt2.get()
            sampleNum = 0
            while (True):
            ...
            with open(r'C:\FR_Nimoy\EmployeeDetails\EmployeeDetails.csv', 'a+') as csvFile:
                writer = csv.writer(csvFile, delimiter=',')
                writer.writerow(row)
                csvFile.close()
            res = "Images Saved for Employee : " + Enrollment + " Name : " + Name
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    recognizer.read("C:\FR_Nimoy\TrainingImageLabel\Trainner.yml")
                except:
                    e = 'Model not found,Please train model'
                    Notifica.configure(text=e, bg="red", fg="black", width=33, font=('times', 15, 'bold'))
                    Notifica.place(x=20, y=250)

                harcascadePath = r"C:\FR_Nimoy\haarcascade_frontalface_default.xml"
                faceCascade = cv2.CascadeClassifier(harcascadePath);
                df = pd.read_csv(r"C:\FR_Nimoy\EmployeeDetails\EmployeeDetails.csv")
                cam = cv2.VideoCapture(0)
    ...
    windo = tk.Tk()
    windo.iconbitmap(r'C:\Users\SUNITA BHATT\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\FR_Nimoy\Attendance\-------Check atttendance-------"')

    attf = tk.Button(windo,  text="Check Data",command=Attf,fg="black"  ,bg="lawn green"  ,width=12  ,height=1 ,activebackground = "Red" ,font=('times', 14, ' bold '))
...
def admin_panel():
    win = tk.Tk()
    win.iconbitmap(r'C:\Users\SUNITA BHATT\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
    win.title("LogIn")
    ...
    def log_in():
        ...
        if username == 'harhit' :
            if password == 'harshitb10':
                ...
                cs = r'C:\FR_Nimoy\EmployeeDetails\EmployeeDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
def trainimg():
    ...
    try:
        recognizer.save(r"C:\FR_Nimoy\TrainingImageLabel\Trainner.yml")
    except Exception as e:
...
window.iconbitmap(r'C:\Users\SUNITA BHATT\Downloads\Attendace_management_system-master\Attendace_management_system-master\AMS.ico')
...
message = tk.Label(window, text="Nimoy-AI-Attendance-Management-System", bg="cyan", fg="black", width=50,
...
lbl = tk.Label(window, text="Enter Employee number", width=20, height=2, fg="black", bg="deep pink", font=('times', 15, ' bold '))
...
AP = tk.Button(window, text="Check Registered Employees",command=admin_panel,fg="black"  ,bg="cyan"  ,width=19 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
